    ...
    return {
        ...
        parseRazorToken: function(loopIterator) {
            ...
            if (loopIterator.currentChar() == '{' || loopIterator.currentChar() == '(') {
                ...
                if (token.toLowerCase() == 'renderBody'.toLowerCase()) {
                ...
                } else if (token.toLowerCase() == 'section'.toLowerCase()) {
                ...
                } else if (token.toLowerCase() == 'renderSection'.toLowerCase()) {
                    loopIterator.skipWhiteSpace();
                    if (loopIterator.currentChar() != '(') {
                ...
                } else if (token.toLowerCase() == 'Url.Content'.toLowerCase()) {
                    loopIterator.skipWhiteSpace();
                    if (loopIterator.currentChar() != '(') {
                ...
                } else if (token.toLowerCase() == 'renderPage'.toLowerCase()) {
                    loopIterator.skipWhiteSpace();
                    if (loopIterator.currentChar() != '(') {
                        throw new Error('Expected "(" after "renderPage".');
                    }
                    loopIterator.next();
                    loopIterator.skipWhiteSpace();
                    var pageToRender = tokenizer.getNextStringLiteral(loopIterator);
                    loopIterator.skipWhiteSpace();
                    if (loopIterator.currentChar() != ')') {
                        throw new Error('Expected ")" after "renderPage".');
                    }
                    loopIterator.next();
                    return this.createRazorToken("renderPage(" + pageToRender  + ")");
                }
                else {
